...
(function () {
    ...
    function featured() {
        ...
        return `<div class="${ui.CARD} overflow-hidden" id="featuredVideo">
            <div class="p-3 bg-slate-900">${ui.videoPlayer({ poster: v.thumb, title: tx(v.title), length: v.length })}</div>
